...
const eCommerceStore =
  (process.env.PUBLIC_URL || "") + "/images/projectImages/E-commerce-store.png";
const TripConnect =
  (process.env.PUBLIC_URL || "") + "/images/projectImages/TripConnect.png";
const FlowBuilder =
  (process.env.PUBLIC_URL || "") + "/images/projectImages/Flow-Builder.png";
  ...
  const projectData = [
    {
      ...
      languages:
        "JavaScript | React.js | React Flow | Node.js | Express.js | MongoDB | Mongoose | Twilio API | OpenAI API | APIs | Ngrok | WhatsApp Business API | MERN Stack",
      image: FlowBuilder,
    ...
    },
    {
      ...
      languages:
        "React JS | Node.js | Express.js | MongoDB | Mongoose | React Router | JWT | Bcrypt | MERN Stack",
      image: TripConnect,
      projectType: "Real-Time Full Stack Travel App",
    },
    {
      sourceCodeLink:
        "https://github.com/Saini-Yogesh/segment-tree-visualization",
      ...
      languages:
        "Next.js | D3.js | JavaScript | HTML | CSS | Segment Tree Algorithm",
      image: SGT,
    ...
    },
    {
      ...
      languages:
        "React JS | Redux | Redux Toolkit | Node.js | Express.js | MongoDB | Mongoose | React Router | JWT | Bcrypt | Tailwind CSS | MERN Stack",
